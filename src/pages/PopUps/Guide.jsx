          ...
          <Accordion title="EVENT GIFTING" defaultOpen={true}>
            <div className="body-item">
              <div className="list-item">
                ...
                <p className="text">
                  When you send event gifts, you will get Gaming Points. 1 bean
                  of event gift sent = 1 Gaming Point.
                </p>
              </div>
              <div className="list-item">
              ...
              <div className="list-item">
                ...
                <p className="text">
                  When you tap on the Gift Box icon, you will get free rewards.
                </p>
              </div>
              <div className="list-item">
                <span className="index">4.</span>
                <p className="text">
                  The pop-up will appear again next day at 00:00:00 GMT when you
                  open the web-page, & you will be able to claim free reward
                  again by clicking on the Gift Box Icon.
                </p>
              </div>
            </div>
          </Accordion>
          ...
          <Accordion title="BILLIARDS">
            <div className="body-item">
              ...
              <div className="list-item">
                ...
                <p className="text">
                  The “Play” button will only enable again when you recharge the
                  cue stick each time.
                </p>
              </div>
              <div className="list-item">
              ...
              <div className="list-item">
                ...
                <p className="text">
                  You can't play the shot if you haven't charged the Cue Stick.
                </p>
              </div>
              <div className="list-item">
                <span className="index">10.</span>
                <p className="text">
                  Each time when you tap on the “Play” button successfully, you
                  will win rewards and Claw points. There’s a 50% chance of
                  receiving 1 claw point and a 50% chance of receiving 0 claw
                  point.
                </p>
              </div>
              <div className="list-item">
                ...
                <p className="text">
                  These claw points will be used in the second part of the event
                  (Claw Crane).
                </p>
              </div>
              <div className="list-item">
              ...
              <div className="list-item">
                ...
                <p className="text">
                  You have to select any one of the combos first then tap on the
                  “Play” button.
                </p>
              </div>
              <div className="list-item">
              ...
              <div className="list-item">
                ...
                <p className="text">
                  A “Balls Potted” counter will be displayed on the webpage and
                  the counter will refresh daily at 00:00:00 GMT.
                </p>
              </div>
              <div className="list-item">
              ...
              <div className="list-item">
                ...
                <p className="text">
                  ...
                  collected Beans will be distributed among the top 3 Rankers of
            ...
            <div className="body-item">
              ...
              <div className="list-item">
                ...
                <p className="text">
                  ...
                  displayed along with the “Play” button.2. On the second tab of
                  the webpage, a foosball table will be displayed along with the
                  “Play” button.
                </p>
              </div>
              <div className="list-item">
              ...
              <div className="list-item">
                <span className="index">9.</span>
                <p className="text">
                  Each time when you get 1 score, the value “1” will be added to
                  the “Daily score” counter.
                </p>
              </div>
              <div className="list-item">
                <span className="index">10.</span>
          ...
          <Accordion title="TALENT WHEEL">
            <div className="body-item">
              <div className="list-item">
                <span className="index">1.</span>
                <p className="text">
                  There are two types of wheels on the webpage. Lucky Wheel and
                  VIP Wheel
                </p>
              </div>
              <div className="list-item">
              ...
              <div className="list-item">
                <span className="index">6.</span>
                <p className="text"> You can spin the wheel multiple times..</p>
              </div>
            </div>
          </Accordion>
        </div>
